...
- Shell/permissions: https://v2.tauri.app/plugin/shell/
...
- Capability permissions: https://v2.tauri.app/learn/security/using-plugin-permissions/
...
- Overview: https://svelte.dev/docs/svelte
