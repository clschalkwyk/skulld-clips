...
| M6 | SCF-056–060 | bounded project-owned MP4 sting, fixed Rust-owned green key/3× right-edge motion/audio mix, transparent sprite preview, visible selection, safe-area anchors, pixel nudging, full-width canvas dock, compact layer rail, clip-relative overlay timing, viewport-contained editor panels and decoded-frame/audio integration |
