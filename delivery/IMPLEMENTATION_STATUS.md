...
| M6 | SCF-056–062 | up to eight bounded project-owned MP4 stings, Rust-owned green key with 1×/2×/3× once/repeat motion and multi-sting audio mix, transparent looping sprite preview, visible selection, safe-area anchors, pixel nudging, full-width canvas dock, compact layer rail, direct seconds-based timing with cycle presets and playhead context, viewport-contained editor panels and decoded-frame/audio integration |
