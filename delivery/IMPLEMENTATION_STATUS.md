...
| M6 | SCF-056–059 | bounded project-owned MP4 sting, fixed Rust-owned green key/3× right-edge motion/audio mix, transparent sprite preview, visible selection, safe-area anchors, pixel nudging, labelled placement sliders, source-fitted top-aligned preview, viewport-contained independently scrolling editor panels and decoded-frame/audio integration |
